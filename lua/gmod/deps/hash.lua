...
-- I just made it compatible with pure lua and made the code stay out of the global scope
-- I also deleted the hash.PseudoRandom function because it's not used anywhere
